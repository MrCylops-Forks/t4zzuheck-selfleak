...
public:
	...
	static void     __fastcall  FrameStageNotify(void* ecx, void* edx, ClientFrameStage_t curStage);
	...
	//static void     __fastcall  DrawSetColor(ISurface* _this, void* edx, int r, int g, int b, int a);
...
private:
	...
	std::unique_ptr<VMTHook> pGetViewModelFov;
	...
	//typedef void(__fastcall*  DrawSetColor_t) (ISurface*, void*, int, int, int, int);
