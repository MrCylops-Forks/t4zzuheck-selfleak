...
class Hud
{
	...
	struct CPanel2D
	{
		void ShowAlert(const char* text, const int mode)
		{
			...
			static Fn fn = (Fn)Utils::FindSignature("client_panorama.dll", "55 8B EC A1 ? ? ? ? 83 EC 08 56 8B F1 57 A8 01 75 26 8B 0D ? ? ? ? 83 C8 01 A3 ? ? ? ? 68 ? ? ? ? 8B 01 FF 90 ? ? ? ? 66 A3 ? ? ? ? A1");
		...
		void HidePanel()
		{
			...
			static Fn fn = (Fn)Utils::FindSignature("client_panorama.dll", "E8 ? ? ? ? 5F 5E 5B 8B E5 5D C2 04 00 8B D3 B9 ? ? ? ? E8 ? ? ? ? 85 C0 0F 85 ? ? ? ? 8B 44 24 14");
