	...
	if (g::pLocalEntity->GetHealth() > 0)
	{
		if ((type) && path.size() > 1)
		{
			...
			for (auto it = path.begin(), end = path.end(); it != end; ++it)
			{
				...
				prev = *it;
				//newpath.push_back(std::pair<Vector, float>(*it, 255.f));
				//deques.push_back(GrenadePath(newpath, weapon->m_fThrowTime(), 2, 2));
			}
			...
			{
				if (WeaponIDz == 43)
					DrawF((int)nadeEnd.x - 5, (int)nadeEnd.y, g::grenade, true, true, Color(255, 255, 255, 255), "i");
				else if (WeaponIDz == 44)
					DrawF((int)nadeEnd.x - 5, (int)nadeEnd.y, g::grenade, true, true, Color(255, 255, 255, 255), "j");
				else if (WeaponIDz == 48)
					DrawF((int)nadeEnd.x - 5, (int)nadeEnd.y, g::grenade, true, true, Color(255, 255, 255, 255), "n");
				else if (WeaponIDz == 46)
					DrawF((int)nadeEnd.x - 5, (int)nadeEnd.y, g::grenade, true, true, Color(255, 255, 255, 255), "l");
				else if (WeaponIDz == 47)
					DrawF((int)nadeEnd.x - 5, (int)nadeEnd.y, g::grenade, true, true, Color(255, 255, 255, 255), "m");
				else if (WeaponIDz == 45)
					DrawF((int)nadeEnd.x - 5, (int)nadeEnd.y, g::grenade, true, true, Color(255, 255, 255, 255), "k");
